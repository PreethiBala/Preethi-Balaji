...
public class SubmitQueryUsingInvalidDetailsExcelTest {
	...
	public void setUpBeforeClass() throws IOException {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/sendQueryInValidDetails.html");
	...
	@Test(dataProvider = "excel-inputsData", dataProviderClass = QueryValidDeatilsDataProviders.class)
	//This is to use a single excel sheet and get inpurts from sheet2 of "C:\\Users\\PreethiBalaji\\Pictures\\1008\\Screenshots\\SubmitQueryUsingValidDetails.xlsx"; 
	...
	public void submitQueryTest(String name, String email, String subject, String message) throws InterruptedException, AWTException {
		//To start the test -"SendQueryInValidDetails"
		extentTest = extent.startTest("SendQueryInValidDetails");
		Thread.sleep(1000);
